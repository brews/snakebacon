...
bacon = Extension("snakebacon.bacon.baconwrap",
                  ...
                  sources=["snakebacon/bacon/baconwrap.pyx", "snakebacon/bacon/input.cpp",
                           "snakebacon/bacon/Matrix.cpp", "snakebacon/bacon/ranfun.cpp", "snakebacon/bacon/vector.cpp",
                  ...
                  extra_compile_args=["-xc++", "-lstdc++", "-shared-libgcc", "-O2", "-fopenmp",
                                      "-D_FILE_OFFSET_BITS=64", "-Wno-write-strings"])
